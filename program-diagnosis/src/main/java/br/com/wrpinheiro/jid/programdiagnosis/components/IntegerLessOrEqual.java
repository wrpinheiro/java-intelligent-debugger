 ...
 *         Fev 1, 2009
 */
public class IntegerLessOrEqual extends IntegerBinaryOperator {

  /**
   * Creates an instance of the less or equal operator in a given system, with a
   * given name.
   * 
   * @param system
   *          the system.
   ...
   * @param line
   */
  public IntegerLessOrEqual(IntegerAbstractComponent system, String name,
   ...
   */
  @Override
  public void propagateBackward(final IntegerPort in1, IntegerPort in2,
  ...
  public String getComponentName() {
    return "Menor ou igual " + formatInfo();
  }
