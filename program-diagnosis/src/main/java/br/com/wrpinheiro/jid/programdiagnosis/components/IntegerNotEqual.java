 ...
 *         09/03/2009
 */
public class IntegerNotEqual extends IntegerBinaryOperator {

  /**
   * Creates an instance of the integer not equal operator (!=).
   * 
   * @param system
   *          the system.
   * @param name
   ...
   * @param line
   */
  public IntegerNotEqual(IntegerAbstractComponent system, String name,
  ...
  public void propagateBackward(IntegerPort in1, IntegerPort in2,
    ...
    if (result.getValue().equals(BooleanUtils.FALSE)) {
  ...
  public String getComponentName() {
    return "Op. Diferença " + formatInfo();
  }
