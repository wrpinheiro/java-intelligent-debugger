 ...
 *         29/03/2008
 */
public class Nand extends IntegerBinaryOperator {
  /**
   ...
   */
  public Nand(IntegerSystem system, String name, Set<Integer> lines,
  ...
  public Nand(IntegerSystem system, String name, int line,
      ComplementaryInfo info) {
