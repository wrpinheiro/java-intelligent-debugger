 ...
 * @author wrp
 */
public class AlternativeSelection extends Conditional implements
    ElementaryPattern {
  public AlternativeSelection(final IntegerAbstractComponent parent,
  ...
  public String getName() {
    return "SeleçãoAlternativa";
  }

  @Override
  public String getComponentName() {
    return "Seleção sequencial " + formatInfo();
  }
}
