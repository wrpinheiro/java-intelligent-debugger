 ...
 *         Sep 4, 2008
 */
public class IntegerLess extends IntegerBinaryOperator {
   ...
   * @param line
   */
  public IntegerLess(IntegerAbstractComponent system, String name,
  ...
  public IntegerLess(IntegerAbstractComponent system, String name, int line,
