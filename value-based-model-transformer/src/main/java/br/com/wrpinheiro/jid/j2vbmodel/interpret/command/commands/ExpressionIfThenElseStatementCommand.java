 ...
 *         Apr 2, 2009
 */
public class ExpressionIfThenElseStatementCommand implements
  ...
  private static final Logger LOG = Logger
      .getLogger(ExpressionIfThenElseStatementCommand.class);
  ...
  public void inNode(final InterpretationContext context, final Node aNode,
    ...
    AExpressionIfThenElseStatement node = (AExpressionIfThenElseStatement) aNode;
    ...
    // gera modelo para a expressão do condicional.
