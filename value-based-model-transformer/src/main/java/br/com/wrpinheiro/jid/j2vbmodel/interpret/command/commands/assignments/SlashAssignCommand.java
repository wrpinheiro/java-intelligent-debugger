...
public class SlashAssignCommand extends AbstractAssignCommand {
	...
	public int getLineOfTheOperator(final PAssignmentOperator op) {
		checkType(op);
		return ((ASlashAssignAssignmentOperator) op).getSlashAssign().getLine();
	}
	...
	public IntegerComponent getComponent(IntegerAbstractComponent system, String name,
		...
		checkType(op);
		return new IntegerDivisor(system, name, this
	...
	public void connect(IntegerComponent comp, String leftSideId,
		...
		IntegerDivisor c = (IntegerDivisor) comp;
